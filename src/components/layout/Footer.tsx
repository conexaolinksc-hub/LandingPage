        ...
        <div className="flex flex-col items-start gap-5">
          ...
          <div className="flex gap-3 mt-1">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="w-9 h-9 rounded-lg bg-bg-surface border border-black/8 flex items-center justify-center text-foreground/65 hover:text-brand-green hover:border-brand-green/30 hover:bg-brand-green/5 transition-all"
            >
          ...
          <ul className="flex flex-col gap-2.5">
            {NAV_LINKS.map((link) => (
              <li key={link.href}>
                <a
                  href={link.href}
                  className="text-sm text-foreground/75 hover:text-brand-blue transition-colors"
                >
                  {link.label}
                </a>
              </li>
          ...
          <ul className="flex flex-col gap-3">
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-3 text-sm text-foreground/75 hover:text-brand-blue transition-colors group"
              >
            ...
            <li>
              <a
                ...
                className="flex items-center gap-3 text-sm text-foreground/75 hover:text-brand-blue transition-colors group"
              >
